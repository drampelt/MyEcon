 ...
 * @author DanielR
 */
public class MyEcon extends JavaPlugin {
	static String mainDirectory = "MyEcon/";
	static File Accounts = new File(mainDirectory + "Users.accounts");
	
    private final MyEconPlayerListener playerListener = new MyEconPlayerListener(this);
    private final HashMap<Player, Boolean> debugees = new HashMap<Player, Boolean>();

    public MyEcon(PluginLoader pluginLoader, Server instance, PluginDescriptionFile desc, File folder, File plugin, ClassLoader cLoader) {
